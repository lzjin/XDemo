...
import com.he.skt.kotlin.xdemo.adapter.MoreAdapter;
...
public class MoreActivity extends AppCompatActivity {
    ...
    private void initRV() {
        mData = new ArrayList<>();
        mAdapter = new MoreAdapter(mData);
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                Toast.makeText(MoreActivity.this, "Child点击" + position, Toast.LENGTH_SHORT).show();
            }
        });
        recylerView.addOnItemTouchListener(new OnItemClickListener() {
            @Override
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                Toast.makeText(MoreActivity.this, "item==" + Integer.toString(position), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getDataList() {
        ...
        for (int i = 0; i < (page == 1 ? 10 : 5); i++) {
            if (page == 1) {
                mData.add(new MoreBean( (i%2==0?0:1),"龙蛋蛋白石费分时段", "https://img.ougo.ltd/FmJ5E9-shKB7Suj3iy0gJkiSeEWK", "¥22" + i, "¥34" + i));
            } else {
                mData.add(new MoreBean( (i%2==0?0:1),"更多数据老胜多负少", "https://img.ougo.ltd/FqDV-hb2yc1SwNAoqAs8U_C-dImg", "¥62" + i, "¥83" + i));
            }
        }
        if (page == 1) {
